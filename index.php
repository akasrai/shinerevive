    ...
    <div class="container py-md-5 py-4">
      <div class="col-md-12 row py-md-4 py-0">
        <div class="col-md-6 py-md-5 my-md-5 py-0 my-0 px-0">
          ...
          <!-- 
          <div class="d-flex">
            <div class="alert alert-warning d-inline">
              <i class="icon ion-md-pricetag mr-2"></i> REFERRRAL OFFER
            </div>
          </div> -->
    ...
    <div class="container">
      <div class="d-flex footer">
        <div class="col-md-12 mt-5">
          ...
          <p class="text-center">
            <a href='https://www.freepik.com/vectors/house'>House vector created by macrovector -
              www.freepik.com</a>
          </p>
